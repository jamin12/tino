---
name: create-skill
description: 새 스킬(.Codex/skills/{스킬명}/SKILL.md) 작성 시 일관된 포맷과 구조를 따르기 위한 가이드라인
user_invocable: true
---
...
#### `meta-file-location`
스킬은 `.Codex/skills/{스킬명}/SKILL.md` 경로에 위치한다. 디렉토리명이 스킬 식별자가 된다.

```
# WRONG
.Codex/skills/my-skill.md
.Codex/my-skill/SKILL.md
...
```
# WRONG
.Codex/skills/CreateSkill/SKILL.md
.Codex/skills/create_skill/SKILL.md
.Codex/skills/my.skill/SKILL.md

# CORRECT
.Codex/skills/create-skill/SKILL.md
.Codex/skills/setup-gradle/SKILL.md
.Codex/skills/frontend-ui-ux/SKILL.md
```
