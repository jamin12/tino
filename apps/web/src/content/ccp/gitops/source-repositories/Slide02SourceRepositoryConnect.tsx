...
export const slideMeta: SlideMeta = {
  screenId: "CCP-GIT-020",
  title: "소스 저장소 생성 (기본정보)",
  ...
  annotations: [
    {
      ...
      label: "필수 입력 영역",
      description:
        "이름, 저장소 그룹, 가시성은 필수 항목(*)입니다. 이름은 Git 저장소의 slug로 사용되며, 저장소 그룹은 논리적 분류, 가시성은 접근 권한 범위를 결정합니다.",
    },
    {
      id: 2,
      label: "브랜치·라이센스·템플릿 설정",
      description:
        "기본 브랜치(main/master/develop), 라이센스, .gitignore 템플릿, README 등 저장소 초기화 옵션을 선택합니다. 구분선 아래에 위치하여 필수 항목과 시각적으로 분리됩니다.",
    },
    {
      id: 3,
      label: "템플릿 저장소 토글",
      description:
        "활성화하면 이 저장소를 템플릿으로 설정하여, 다른 저장소 생성 시 이 저장소의 구조를 기반으로 복제할 수 있습니다.",
    },
    {
      id: 4,
      label: "초기화 토글",
      description:
        "활성화 시 .gitignore, 라이센스, README 파일이 자동으로 추가된 상태로 저장소가 생성됩니다. 물음표 아이콘을 통해 상세 설명을 확인할 수 있습니다.",
    },
    {
      id: 5,
      label: "저장소 URL",
      description:
        "생성될 저장소의 Git URL이 미리 표시됩니다. 클립보드 버튼으로 URL을 복사하여 로컬 환경에서 clone 명령에 바로 사용할 수 있습니다.",
    },
    {
      id: 6,
      label: "생성 / 취소",
      description:
        "생성 버튼을 클릭하면 입력된 정보로 소스 저장소가 생성됩니다. 취소 시 이전 소스 저장소 목록 화면으로 돌아갑니다.",
    },
  ],
};
...
export default function Slide02SourceRepositoryConnect() {
      ...
      <div className="flex gap-0 mx-8 mt-4">
        ...
        <div className="flex-1 bg-white rounded-lg border border-[#e5e5e5] p-6">
          <div className="space-y-5">
            {/* 이름 */}
            <InfoRow data-annotation-id="1" label={<span>이름<span className="text-[#da1e28]">*</span></span>} labelWidth="120px">
              <input
                type="text"
                value="app1-backend"
                readOnly
            ...
            <div className="border-t border-[#e5e5e5]" />
                ...
                {/* 기본 브랜치 */}
                <InfoRow data-annotation-id="2" label="기본 브랜치" labelWidth="120px">
                  <Select
                    label=""
                    options={[
                ...
                {/* 저장소 */}
                <InfoRow data-annotation-id="3" label="저장소" labelWidth="120px">
            ...
            {/* 저장소 URL */}
            <InfoRow data-annotation-id="5" label="저장소 URL" labelWidth="120px">
