...
export const slideMeta: SlideMeta = {
  ...
  annotations: [
    ...
    { id: 11, label: "구성 탭 전환", description: "기본정보, 타입 정보, Data Keys 하위 탭으로 구성 정보를 분류하여 탐색합니다. 현재 Data Keys 탭이 활성화되어 있습니다." },
    { id: 12, label: "Data Keys 목록", description: "Secret에 포함된 키(DB_HOST, DB_USER, DB_PASS)를 이름과 마스킹된 값으로 표시합니다. 보안상 실제 값은 숨겨져 있습니다." },
  ],
};
...
export default function SlideSecretsDetailData() {
  return (
    <CcpDashboardLayout
          ...
          >
            ...
            <div className="flex-1 px-4 pt-4 pb-4" data-annotation-id="12">
              <div className="bg-white rounded-sm border border-[#f0f0f0] shadow-[0px_0px_8px_#00000014] px-5 py-4 flex flex-col gap-3">
                <InfoRow label="이름">
                  <TextCell bold color="#111" className="text-[13px]">DB_HOST</TextCell>
                </InfoRow>
                <InfoRow label="값">
                  <TextCell color="#999" className="text-[12px]">●●●●●●●●</TextCell>
                </InfoRow>
                <Divider />
                <InfoRow label="이름">
                  <TextCell bold color="#111" className="text-[13px]">DB_USER</TextCell>
                </InfoRow>
                <InfoRow label="값">
                  <TextCell color="#999" className="text-[12px]">●●●●●●●●</TextCell>
                </InfoRow>
                <Divider />
                <InfoRow label="이름">
                  <TextCell bold color="#111" className="text-[13px]">DB_PASS</TextCell>
                </InfoRow>
                <InfoRow label="값">
                  <TextCell color="#999" className="text-[12px]">●●●●●●●●</TextCell>
                </InfoRow>
