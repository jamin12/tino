...
export const slideMeta: SlideMeta = {
  screenId: "CCP-STR-004-D2",
  title: "ConfigMaps 구성 - 기본정보",
  section: "CI/CD 저장소",
  links: [
  ...
  annotations: [
    ...
    { id: 10, label: "구성 탭 전환", description: "기본정보, 설정, Data 하위 탭으로 구성 정보를 분류하여 탐색합니다. 현재 기본정보 탭이 활성화되어 있습니다." },
    { id: 11, label: "기본정보", description: "ConfigMap의 이름, 네임스페이스, API 버전, 생성일, UID 등 메타데이터를 표시합니다." },
  ],
};
...
export default function SlideConfigMapsDetailConfig() {
  return (
    <CcpDashboardLayout
        ...
        detail={
          ...
          >
            ...
            <div className="px-5" data-annotation-id="10">
              <Tabs items={configTabs} activeId="basic" />
            </div>
            ...
            <div className="flex-1 px-4 pt-4 pb-4" data-annotation-id="11">
              <div className="bg-white rounded-sm border border-[#f0f0f0] shadow-[0px_0px_8px_#00000014] px-5 py-4 flex flex-col gap-3">
                ...
                <InfoRow label="생성일">
                  <TextCell color="#6d7073" className="text-[13px]">2025-02-28T09:15:00Z</TextCell>
                </InfoRow>
                <InfoRow label="UID">
                  <TextCell color="#999" className="text-[12px]">
                    a3d8b2f1-4e6c-4a8f-b9d1-2c5e7f8a0b3d
                  </TextCell>
                </InfoRow>
              </div>
            </div>
