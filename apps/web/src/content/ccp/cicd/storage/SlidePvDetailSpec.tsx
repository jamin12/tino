...
export default function SlidePvDetailSpec() {
  return (
    <CcpDashboardLayout
          ...
          >
            ...
            <div className="flex-1 px-4 pt-4 pb-4">
              <div className="bg-white rounded-sm border border-[#f0f0f0] shadow-[0px_0px_8px_#00000014] px-5 py-4 flex flex-col gap-3">
                ...
                <InfoRow label="Mount Options">
                  <Badge variant="neutral" size="sm">noatime</Badge>
                  <Badge variant="neutral" size="sm">nodiratime</Badge>
                </InfoRow>
                <InfoRow label="Node Affinity">
                  <TextCell color="#6d7073" className="text-[13px]">worker-node-01</TextCell>
                </InfoRow>
                <InfoRow label="PV Source">
                  <TextCell color="#6d7073" className="text-[13px]">local: /mnt/data/pv-01</TextCell>
                </InfoRow>
              </div>
            </div>
          </ResourceDetailPanel>
