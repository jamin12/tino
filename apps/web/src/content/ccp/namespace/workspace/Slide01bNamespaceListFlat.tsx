...
const tableData: NamespaceResourceRow[] = [
  ...
  { id: "7", gitopsColor: "#00b30e", name: "sample-prd", cluster: "prd-cluster", status: "Active", statusVariant: "green-solid", labels: 2, age: "25d" },
  { id: "8", gitopsColor: "#00b30e", name: "payment-cicd", cluster: "dev-cluster", status: "Active", statusVariant: "green-solid", labels: 3, age: "20d" },
  { id: "9", gitopsColor: "#cccccc", name: "istio-system", cluster: "dev-cluster", status: "Active", statusVariant: "green-solid", labels: 4, age: "90d" },
  { id: "10", gitopsColor: "#cccccc", name: "argocd", cluster: "dev-cluster", status: "Active", statusVariant: "green-solid", labels: 2, age: "90d" },
  { id: "11", gitopsColor: "#cccccc", name: "temp-test", cluster: "dev-cluster", status: "Terminating", statusVariant: "warning", labels: 0, age: "2d" },
];
